...
// Check the size of Hydro_IC is equal to amr->BoxSize
   if ( fluid_xmax != amr->BoxSize[0]
    ||  fluid_ymax != amr->BoxSize[1]
    ||  fluid_zmax != amr->BoxSize[2] )
      Aux_Error( ERROR_INFO, "The size of Hydro_IC (%f, %f, %f) != (%f, %f, %f) !!\n",
                 fluid_xmax, fluid_ymax, fluid_zmax, amr->BoxSize[0], amr->BoxSize[1], amr->BoxSize[2] );
